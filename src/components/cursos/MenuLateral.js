  ...
  return (
    <>
      <div className="painelComponent">
        <img className="imagemLogo" src={require("../cursos/logoSenaiOrigin.png")}></img>
        <div className="navegacao">
          <Nav variant="tabs" defaultActiveKey="/cursos">
            ...
            <Nav.Item className="navItem">
              <Nav.Link style={{ backgroundColor: "#0496ff", color: "#fff", border: "none", borderRadius: 7 }} className="navLink" href="/cursos">
