...
function CadTurma() {
   ...
   const horarioInicialElementId = document.getElementById("horarioInicial")

   const horarioFinalElementId = document.getElementById("horarioFinal")
    ...
    const turma = {
        ...
        horarioInicio: { 
            id: horarioInicioValue, 
            horario: horarioInicialElementId  },
        horarioTermino: { 
            id: horarioFinalValue, 
            horario: horarioFinalElementId }
    }
                            ...
                            <div className="select2">
                                ...
                                <FormControl variant="standard" sx={{ m: 1, minWidth: 200 }}>
                                    ...
                                    >
                                        ...
                                        {
                                            horarios.map((obj) => (
                                                <MenuItem name="horario" value={obj.id} id="valor2">
                                                    {obj.horario}
                            ...
                            <div className="select3">
                                ...
                                <FormControl variant="standard" sx={{ m: 1, minWidth: 200 }}>
                                    ...
                                    >
                                        ...
                                        {
                                            horarios.map((obj) => (
                                                <MenuItem name="horario" value={obj.id} id="valor1">
                                                    {obj.horario}
