...
export default function LogTurma() {
    ...
    const atualizaLista = async () => {
        const result = await fetch("http://localhost:8080/api/log/logTurma"); // await = espera uma promessa
        const resultado = await result.json();
        setLogTurma(resultado);
      };
    ...
    const buscaTurma = async (event) => {
        ...
        if (key) {
          ...
          let result = await fetch(
            "http://localhost:8080/api/log/buscarTurma/", {
                                        ...
                                        cad === true
                                            ...
                                            del === true || alt === true
                                                ...
                                                <>
                                                    <StyledTableCell>Mensagem</StyledTableCell>
                                                    <StyledTableCell>CodigoTurma</StyledTableCell>
                                                    <StyledTableCell>NiNif de quem fez a ação:</StyledTableCell>
                                                    <StyledTableCell>Data</StyledTableCell>
                                                    <StyledTableCell>Hora</StyledTableCell>
                                                    <StyledTableCell>Excluir</StyledTableCell>
                                                </>
                                                    ...
                                                    <>

                                                        {
                                                            logsEnum === "CADASTROU"
                                                                ?
                                                                <>
                                                                    <StyledTableCell>{nomeUsuario} {logsEnumString} uma turma</StyledTableCell>
                                                                    <StyledTableCell>{codigoTurma}</StyledTableCell>
